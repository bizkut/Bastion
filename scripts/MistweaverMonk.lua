...
local InvokeChiJi = SpellBook:GetSpell(325197):SetOffGCD(true)
local SoothingMist = SpellBook:GetSpell(115175)
local ManaTea = SpellBook:GetSpell(115294):SetOffGCD(true)
local CelestialConduit = SpellBook:GetSpell(443028):SetOffGCD(true)
...
local JadefireStomp = SpellBook:GetSpell(388193):SetOffGCD(true)
...
local ChiBurst = SpellBook:GetSpell(123986):SetOffGCD(true)
